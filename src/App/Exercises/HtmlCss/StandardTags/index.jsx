  ...
  return (
    <div className="standard-tags">
      ...
      <div class="faked-tags">
        <div class="ft-h1">Tytuł</div> <span class="ft-small">05.2023</span>{' '}
        <div class="ft-h3">
          H<span class="ft-sub ft-small">2</span>O is good for you{' '}
        </div>{' '}
        <p>
          Staying <span class="ft-bold">hydrated</span> is one of the best
          things you can do for your overall health. Staying{' '}
          <span class="ft-bold">hydrated</span> can help support physical
          performance, prevent headaches and constipation, and more.{' '}
        </p>{' '}
        <div class="ft-h3">
          25<span class="ft-sup ft-small">th</span> birthday{' '}
        </div>{' '}
        <p>
          Make the next birthday you celebrate a special one with a hand-picked
          happy birthday <q>quote</q> or wish that will surely make that special
          ...
          <span class="ft-italic">happy birthday</span>
          <span>quotes</span> to help put a smile on someone’s face. From
          inspirational to funny to cute sayings, browse our list of{' '}
          <span>quotes</span> to find one that resonates with you.
          <span class="ft-line">Nothing</span>
          can stop you!{' '}
        </p>{' '}
        <div class="ft-h3">
          Why not to use <span class="ft-underline">lists</span> ?{' '}
        </div>{' '}
        <p>
          {' '}
          <div class="ft-h5">
            A lot of things to do <span class="ft-italic">#todo</span>{' '}
          </div>{' '}
          <div class="ft-ul">
            <div class="ft-li">Todo 1</div>
            <div class="ft-li">Todo 2</div>
            <div class="ft-li">Todo 3</div>{' '}
          </div>{' '}
        </p>{' '}
      </div>{' '}
    </div>
